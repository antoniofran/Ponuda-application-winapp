...
namespace PonudaApp
{
    public partial class NovaPonuda : Form
    {
        ...
        private void NovaPonuda_Load(object sender, EventArgs e)
        {
        ...
        private void TraktoriComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (KabinaComboBox.SelectedItem == null)
            {
                for (int i = 0; i < KabinaComboBox.Items.Count; i++)
                {
                    if ( ((Kabina)KabinaComboBox.Items[i]).idKabine == ((Traktor)TraktoriComboBox.SelectedItem).kabinaTraktora.idKabine )
                    {
        ...
        private void ObradiPonuduGumb_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                tempPonuda.indexPonude = tempListaPonuda.Count;

                /* *********************** */

                tempListaPonuda.Add(tempPonuda);
